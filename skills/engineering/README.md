...
- **[implement-spec-tickets](./implement-spec-tickets/SKILL.md)** — Optionally execute an approved spec or ticket set as one recoverable batch through isolated ticket branches, review gates, squash merges, and integrated review.
