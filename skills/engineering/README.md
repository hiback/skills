...
- **[implement-batch](./implement-batch/SKILL.md)** — Optionally execute an approved spec or explicit ticket set as one recoverable serial batch through isolated ticket branches, review gates, squash merges, and integrated review.
