...
- **[implement-batch](./implement-batch/SKILL.md)** — Optionally execute an approved spec or explicit ticket set as one recoverable serial batch, giving every ticket a fresh implementer, its own branch, a `/code-review` gate, and one squash commit.
